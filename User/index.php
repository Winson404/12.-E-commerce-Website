						...
						<div class="product-info">
							<div class="nav-main">
								...
								<ul class="nav nav-tabs" id="myTab" role="tablist">
									...
									?>
									<li class="nav-item"><a class="nav-link" href="product_category.php?category_Id=<?php echo $row['cat_Id']; ?>" role="tab"><?php echo $row['cat_name']; ?></a></li>
									<?php } ?>
								</ul>
								<!--/ End Tab Nav -->
							</div>
							<div class="tab-content" id="myTabContent">
								...
								<div class="tab-pane fade show active" id="man" role="tabpanel">
									<div class="tab-single">
										<div class="row">
											<?php 
												$fetch = mysqli_query($conn, "SELECT * FROM product WHERE product_stock > 0 LIMIT 8");
												while ($row = mysqli_fetch_array($fetch)) {
													...
													<div class="product-img">
														...
														<div class="button-head">
															...
															<div class="product-action-2">
																<a title="Add to cart" href="process_save.php?product_Id=<?php echo $row['product_Id']; ?>&&user_Id=<?php echo $id; ?>&&product_price=<?php echo $row['product_price']; ?>">Add to cart</a>
															</div>
														</div>
													</div>
													<div class="product-content">
														<h3><a href="product-details.php?product_Id=<?php echo $row['product_Id']; ?>" type="button"><b><?php echo $row['product_name']; ?></b></a></h3>
                ...
                <div class="col-12">
                    <div class="owl-carousel popular-slider">
						...
						<div class="single-product">
							...
							<div class="product-content">
								<h3><a href="product-details.php?product_Id=<?php echo $row['product_Id']; ?>"><b><?php echo $row['product_name']; ?></b></a></h3>
								<div class="product-price">
