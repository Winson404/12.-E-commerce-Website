				...
				<div class="col-12">
					<div class="bread-inner">
						<ul class="bread-list">
							...
							<li class="active"><a href="purchaseHistory.php">Purchased Items History</a></li>
						</ul>
					</div>
				</div>
			</div>
					...
					<table class="table shopping-summery">
						...
						<tbody>
							<?php 
								...
								$a = mysqli_query($conn, "SELECT * FROM cart JOIN users ON cart.cart_user_Id=users.user_Id JOIN product ON cart.cart_product_Id=product.product_Id WHERE cart.cart_user_Id='$id' AND cart.cart_status='Confirmed' AND cart.receivingStatus='Received' ");
							...
							<tr class="text-center">
								...
								<td class="text-center" data-title="Qty"><?php echo $b['cart_quantity']; ?></td>
								<td class="text-center" data-title="Qty"><?php echo date("F d, Y", strtotime($b['date_added'])); ?></td>
