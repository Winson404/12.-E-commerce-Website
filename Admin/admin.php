<title>Administrators | SC E-commerce</title>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <div class="d-flex">
                  <button type="button" class="btn btn-info" data-toggle="modal" data-target="#add_admin"><i class="bi bi-plus-circle"></i> Add</button>
                  ...
                  <tbody id="users_data">
                    <tr>
                      ...
                      ?>
                        ...
                        <td><span class="badge badge-info rounded-pill"><?php echo $row['user_type']; ?></span></td>
                        <td>
