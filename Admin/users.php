<title>Registered user | SC E-commerce</title>
                        ...
                        <td>
                            <div class="dropdown dropleft">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownmenuButton">
                                      <button type="button" class="btn btn-primary dropdown-item" data-toggle="modal" data-target="#view<?php echo $row['user_Id']; ?>">Profile</button>
                                      <a href="invoice.php?user_Id=<?php echo $row['user_Id']; ?>" type="button" class="btn btn-primary dropdown-item">View check-outs</a>
